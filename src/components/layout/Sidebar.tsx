...
function OrdineLogo({ size = 28 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Large arc r=12 */}
      <path d="M 26 14 A 12 12 0 1 1 14 2" stroke="#8B1A1A" strokeWidth="2.3" strokeLinecap="round" fill="none"/>
      {/* Medium arc r=8.5 */}
      <path d="M 22.5 14 A 8.5 8.5 0 1 1 14 5.5" stroke="#8B1A1A" strokeWidth="2.3" strokeLinecap="round" fill="none"/>
      {/* Small arc r=5 */}
      <path d="M 19 14 A 5 5 0 1 1 14 9" stroke="#8B1A1A" strokeWidth="2.3" strokeLinecap="round" fill="none"/>
