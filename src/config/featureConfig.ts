...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: 'daily-plan',        labelAr: 'البلان اليومي',              i18nKey: 'dailyPlan',    icon: '📆', roles: ['scientific_rep','team_leader','supervisor','company_manager','admin','manager','user','office_employee'] },
  { id: 'master-survey',     labelAr: 'سيرفي اوردين',               icon: '🗂️', roles: [] },
  { id: 'fms',               labelAr: 'FMS — عينات شهرية',         icon: '🧪', roles: ['company_manager','admin','manager','office_employee'] },
  ...
  { id: 'file-filter',       labelAr: 'تنقية الملفات',              icon: '🗂️', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','office_employee'] },
  { id: 'pharmacy-analysis', labelAr: 'Pharmacy Net',                icon: '🔬', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','supervisor','team_leader','office_employee'] },
  { id: 'item-analysis',     labelAr: 'تحليل الإيتم',                icon: '🔍', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','supervisor','team_leader','office_employee'] },
  { id: 'account-builder',   labelAr: 'الحساب',                     icon: '🧮', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','supervisor','team_leader','office_employee'] },
  { id: 'bonus-sales',       labelAr: 'Bonus',                      icon: '🎁', roles: ['admin','manager','company_manager','team_leader','commercial_team_leader','commercial_supervisor','office_manager','scientific_rep','commercial_rep','office_employee'] },
  { id: 'reports',           labelAr: 'التقارير',                   i18nKey: 'reports',      icon: '📋', roles: ['admin','manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','office_employee'] },
  { id: 'users',             labelAr: 'المستخدمين',                 i18nKey: 'users',        icon: '👥', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','team_leader','supervisor','office_employee'] },
  { id: 'commercial',        labelAr: 'التجاري',                    icon: '💰', roles: ['commercial_rep','commercial_team_leader','commercial_supervisor','office_manager','admin','manager','office_employee'] },
  { id: 'org-structure',     labelAr: 'الهيكلية',                   icon: '🏗️', roles: ['company_manager','admin','manager','office_manager','supervisor','product_manager','team_leader','commercial_supervisor','commercial_team_leader','office_employee'] },
  { id: 'aqdar-export',      labelAr: 'أقدر',                       icon: '📤', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','office_employee'] },
];
...
export const PAGE_DESCRIPTIONS: Record<string, string> = {
  ...
  'stock-ledger':      'صفحة رصيد المذاخر — متابعة ما تبقّى فعلاً في كل مذخر: الستوك الافتتاحي + التعزيزات − المبيع، مع تنبيه إعادة الطلبية',
...
export const PAGE_CHILDREN: Record<string, FeatureNode[]> = {
  ...
  'stock-ledger': [
    { key: 'stock_ledger_baseline',        label: 'تحديث الستوك الافتتاحي',  icon: '📥', desc: 'استيراد ستوك المذاخر من ملف Stock موجود أو ملف Excel — يصفّر القديم للأزواج الواردة فيه' },
    { key: 'stock_ledger_movement_upload', label: 'رفع المبيع والتعزيزات', icon: '🔄', desc: 'رفع ملف Excel للمبيع الخارج من المذاخر أو للتعزيزات الداخلة إليها' },
    { key: 'stock_ledger_manual',          label: 'إدخال حركة يدوية',      icon: '✍️', desc: 'إضافة حركة مبيع أو تعزيز لمذخر واحد بدون ملف' },
    { key: 'stock_ledger_alerts',          label: 'تنبيهات الطلبيات',      icon: '🚨', desc: 'قائمة المذاخر التي شارفت ايتماتها على النفاد مع الكمية المقترحة' },
