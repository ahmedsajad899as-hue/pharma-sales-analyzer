...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: 'pharmacy-analysis', labelAr: 'Pharmacy Net',                icon: '🔬', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','supervisor','team_leader','office_employee','office_hr'] },
  { id: 'item-analysis',     labelAr: 'تحليل الإيتم',                icon: '🔍', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','supervisor','team_leader','office_employee','office_hr'] },
  { id: 'account-builder',   labelAr: 'الحساب',                     icon: '🧮', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','supervisor','team_leader','office_employee','office_hr'] },
  { id: 'bonus-sales',       labelAr: 'Bonus',                      icon: '🎁', roles: ['admin','manager','company_manager','team_leader','commercial_team_leader','commercial_supervisor','office_manager','scientific_rep','commercial_rep','office_employee','office_hr'] },
  { id: 'reports',           labelAr: 'التقارير',                   i18nKey: 'reports',      icon: '📋', roles: ['admin','manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','office_employee','office_hr'] },
  { id: 'users',             labelAr: 'المستخدمين',                 i18nKey: 'users',        icon: '👥', roles: ['admin','manager','company_manager','product_manager','office_manager','commercial_supervisor','commercial_team_leader','user','scientific_rep','team_leader','supervisor','office_employee','office_hr'] },
