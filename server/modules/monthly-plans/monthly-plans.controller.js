...
• entryId: إذا كنت متأكداً جداً أن الطبيب المنطوق يطابق أحد أطباء قائمة البلان أدناه (فروق تشكيل أو نطق بسيطة فقط)، أرجع الـ id الرقمي من القائمة. وإلا اتركه null
